...
- **Output is scored as a rate against the team's average**: each total divided by the days the range spans, read against the *mean* rate across the people it could be measured on, with twice that mean scoring full marks. One person's extraordinary month no longer pushes every colleague down, and somebody who joined halfway through the range is not penalised for the half they were not there
